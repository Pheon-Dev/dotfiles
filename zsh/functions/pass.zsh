...
alias pass-insert="pass insert" # plus name or nae/sub-name
alias pass-gen="pass generate" # plus name
alias pass-find="pass find" # name
alias pass-list="pass"
alias pass-show="pass show" #name
alias pass-grep="pass grep" # 'name'
alias pass-rm="pass rm" # name
alias pass-remote="pass git remote add origin git@github.com:Pheon-Dev/pwd-store.git"
