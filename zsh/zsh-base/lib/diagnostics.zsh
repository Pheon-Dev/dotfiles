# diagnostics.zsh
#
# Diagnostic and debugging support for zsh
...
# zsh, zsh, and the user's system. This is intended to provide a
...
#
# This is intended to be widely portable, and run anywhere that zsh does.
...
function _omz_diag_dump_one_big_text() {
  ...
  # installation
  builtin echo installation:
  command ls -ld ~/.z*
  builtin echo
  builtin echo zsh git state:
